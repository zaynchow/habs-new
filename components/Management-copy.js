...
const Management = ({ data }) => {
  ...
  return (
    <SectionContainer className="py-16 px-12 bg-blue ">
      <div className="md:flex md:h-[520px] w-full">
        <div className="md:w-2/5 relative">
          <div className="md:h-[85%] h-[300px] relative bg-black">
            <Image src={urlFor(data[currSlideIdx].image).url()} fill />
          </div>
          <div className="md:h-[15%] flex items-center bg-white pl-2">
            <P className="">
              <span className="font-semibold ">{data[currSlideIdx].name}</span>
              <br />
