...
const Popup = ({ setPopupVisibility }) => {
  return (
    <div className="md:w-[900px] w-[90vw] md:h-[450px] h-[90vh] bg-yellow mx-auto relative flex items-center md:flex-row flex-col">
      ...
      <div className="md:w-1/2 relative md:h-[450px] h-[60vh] flex flex-col items-start justify-center md:pr-8 p-6">
        <h2 className="inline-block text-left mb-4">
          <span className="md:text-[14px] text-[1.5vh]">Get Upto</span>
          <br />
          <span className="font-lora font-semibold md:text-[85px] text-[9vh] md:leading-[90px] leading-[65px]">
            50% OFF
          </span>
          <br />
          <span className="md:text-[50px] text-[4vh] md:leading-[0.95] leading-[32px]">
            In Commissions
          </span>
        </h2>
        <P className="md:text-inherit text-[2vh]">
